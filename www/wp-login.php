...
default:
	...
	if ( isset( $_REQUEST['redirect_to'] ) ) {
		...
		$redirect_to = '/?cid=profile';//admin_url();
	}
...
<?php		exit;
		...
		if ( ( empty( $redirect_to ) || $redirect_to == 'wp-admin/' || $redirect_to == admin_url() ) ) {
			...
			elseif ( !$user->has_cap('edit_posts') )
				$redirect_to = '/?cid=profile';//admin_url('profile.php');
		}
		wp_safe_redirect($redirect_to);
		exit();
	}
...
<strong>De ce să îți creezi cont / de ce să te autentifici?</strong>
<p>
Este nevoie de conturi de utilizatori pentru a putea introduce următoarele
facilități:<br/>

<ul>
	<li>
	Anotarea legilor cu "pro taxe", "anti Adrian Năstase" pentru a
	determina convingerile parlamentarilor. Pentru început aceste anotări vor fi
	private.<br><br>
	</li>

	<li>
	Personalizarea site-ului. Dacă pe mine mă interesează un anume parlamentar,
	ar trebui să îl pot 'salva' undeva și apoi să îi văd undeva doar pe cei salvați.
	</li>
</ul>

Pentru moment aceste facilități nu sunt implementate, dar puteți folosi
