...
<table width=970 cellspacing=15>
  <tr>
    ...
    <td width=100% valign=top>
      <p class="smalltitle"><strong>Cei mai prezenti senatori</strong></p>
      <table width=100%>
      <tr>
        <td></td>
        <td><a href="/?cid={$cid}&sid=1&sort=0">Nume</a></td>
        <td><a href="/?cid={$cid}&sid=1&sort=1">Colegiu</a></td>
        <td><a href="/?cid={$cid}&sid=1&sort=2">Partid</a></td>
        <td><a href="/?cid={$cid}&sid=1&sort=3">Prezență</a></td>
        <td align="right"><a href="/?cid={$cid}&sid=1&sort=4">Rebel</a></td>
      </td>
