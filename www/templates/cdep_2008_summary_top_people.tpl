...
<table width=970 cellspacing=15>
  <tr>
    ...
    <td width=465 valign=top>
      <div class="smalltitle"><strong>Cei mai prezenți deputați</strong></div>
      <table width=460>
    ...
    <td width=465 valign=top>
      <div class="smalltitle"><strong>Cei mai absenți deputați</strong></div>
      <table width=465>
  ...
  <td colspan="2" align="right">
    <a href="?c=camera+deputatilor+2009&cid=11&sid=1">vezi lista completa...</a>
  </td>
  </tr>
</table>
