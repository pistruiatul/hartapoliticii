...
<table width=970 cellspacing=15>
  <tr>
    <td width=970 valign=top>
      ...
      <tr>
        <td colspan="3"><div class="smalltitle"><strong>Cele mai recente chestiuni votate in Senat</strong></div></td>
        <td>DA</td>
        <td>NU</td>
        <td>Ab</td>
        <td>-</td>
      ...
      {strip}
        <tr>
          ...
          <td valign="top">
            <div class="medium">
              <a href="{$mostRecentVotes[mrvc].law_link}">PL {$mostRecentVotes[mrvc].law_number}</a>&nbsp;
