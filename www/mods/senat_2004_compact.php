...
$t = new Smarty();
// set the cache_lifetime to 1 day, since this info rarely updates, if ever.
$t->caching = 2;
$t->cache_lifetime = 86400;

if (!$t->is_cached('mod_senat_2004.tpl', $person->id)) {
...
$t->display('mod_senat_2004.tpl', $person->id);
